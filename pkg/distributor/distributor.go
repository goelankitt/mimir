...
func (cfg *Config) RegisterFlags(f *flag.FlagSet, logger log.Logger) {
	...
	f.IntVar(&cfg.MaxRecvMsgSize, globalerror.MaxRecvMsgSizeFlag, 100<<20, "Max message size in bytes that the distributors will accept for incoming push requests to the remote_write API. If exceeded, the request will be rejected.")
